...
// Paleta de colores inspirada en el diseño moderno
const lightPalette = {
  primary: {
    main: '#6366F1', // Azul índigo moderno
    light: '#818CF8',
    dark: '#4F46E5',
    contrastText: '#FFFFFF',
  },
...
const darkPalette = {
  primary: {
    main: '#818CF8', // Azul índigo claro
    light: '#A5B4FC',
    dark: '#6366F1',
    contrastText: '#000000',
  },
  secondary: {
    main: '#F472B6', // Rosa claro
    light: '#F9A8D4',
    dark: '#EC4899',
    contrastText: '#000000',
  },
  background: {
    default: '#0F172A', // Azul marino oscuro (como en la imagen)
    paper: '#1E293B', // Azul grisáceo oscuro
  },
  text: {
...
export const darkTheme = createTheme({
  ...
  components: {
    ...
    MuiCard: {
      styleOverrides: {
        root: {
          boxShadow: '0 4px 6px -1px rgba(0, 0, 0, 0.4), 0 2px 4px -1px rgba(0, 0, 0, 0.24)',
          borderRadius: 16,
          transition: 'all 0.3s ease',
          '&:hover': {
